...
/* Definitions for blink_th1 */
osThreadId_t blink_th1Handle;
const osThreadAttr_t blink_th1_attributes = {
  .name = "blink_th1",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* Definitions for blink_th2 */
osThreadId_t blink_th2Handle;
const osThreadAttr_t blink_th2_attributes = {
  .name = "blink_th2",
...
/**
  * @brief  Function implementing the blink_th1 thread.
...
void StartBlink1(void *argument){
	...
	for(;;){
		...
		osDelay(600); // RTOS Specific Delay!
	}
}

/* USER CODE BEGIN Header_StartBlink2 */
/**
* @brief Function implementing the blink_th2 thread.
* @param argument: Not used
* @retval None
*/
